...
def choice():
    ...
    return render_template('choice.html', user_input=user_input)
...
def result():
    ...
    origin_weather = Weather.openWeather(origin)
    ...
    return render_template('flightPrice.html', flights=results, origin=origin, destination=destination,origin_weather=origin_weather,dest_weather=dest_weather, adults = adults,return1=return1,depart=depart)
...
def act():
    ...
    return render_template('act.html', user_input=user_input, data=data)
...
def hotelResult():
    ...
    return render_template('hotels.html', data = data, user_input = user_input, checkIn = checkIn,
                            checkOut = checkOut, adultNum = adultNum , len =len)
